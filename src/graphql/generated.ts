...
export type InterfaceInfoFragment = {
    __typename?: "InterfaceDefinition";
    id: string;
    visibleInterface?: {
        __typename?: "Interface";
...
export type RelationInfoFragment = {
    __typename?: "Relation";
    id: string;
    template: { __typename?: "RelationTemplate"; id: string };
    templatedFields: Array<{ __typename?: "JSONField"; name: string; value?: any | null }>;
...
export type UpdateRelationMutation = {
    __typename?: "Mutation";
    updateRelation: { __typename?: "UpdateRelationPayload"; relation: { __typename?: "Relation"; id: string } };
};
...
export type CreateIntraComponentDependencySpecificationMutation = {
    __typename?: "Mutation";
    createIntraComponentDependencySpecification: {
        __typename?: "CreateIntraComponentDependencySpecificationPayload";
        intraComponentDependencySpecification: { __typename?: "IntraComponentDependencySpecification"; id: string };
    };
};
...
export type UpdateIntraComponentDependencySpecificationMutation = {
    __typename?: "Mutation";
...
export type AddInterfaceSpecificationVersionToComponentVersionMutation = {
    __typename?: "Mutation";
...
export type DeleteIntraComponentDependencySpecificationMutation = {
    __typename?: "Mutation";
    deleteIntraComponentDependencySpecification: { __typename: "DeleteNodePayload" };
};
...
export const AddInterfaceSpecificationVersionToComponentVersionDocument = gql`
    mutation addInterfaceSpecificationVersionToComponentVersion(
        ...
        addInterfaceSpecificationVersionToComponentVersion(
            ...
            componentVersion {
                interfaceDefinitions(
                    filter: { interfaceSpecificationVersion: { id: { eq: $interfaceSpecificationVersion } } }
                ) {
                    nodes {
                        visibleInterface {
                            id
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        ...
        updateRelation(
            variables: UpdateRelationMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<UpdateRelationMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<UpdateRelationMutation>(UpdateRelationDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders
                    }),
                "updateRelation",
        ...
        createIntraComponentDependencySpecification(
            variables: CreateIntraComponentDependencySpecificationMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<CreateIntraComponentDependencySpecificationMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<CreateIntraComponentDependencySpecificationMutation>(
                        CreateIntraComponentDependencySpecificationDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
                "createIntraComponentDependencySpecification",
        ...
        updateIntraComponentDependencySpecification(
            variables: UpdateIntraComponentDependencySpecificationMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<UpdateIntraComponentDependencySpecificationMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<UpdateIntraComponentDependencySpecificationMutation>(
                        UpdateIntraComponentDependencySpecificationDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
                "updateIntraComponentDependencySpecification",
        ...
        deleteIntraComponentDependencySpecification(
            variables: DeleteIntraComponentDependencySpecificationMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<DeleteIntraComponentDependencySpecificationMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<DeleteIntraComponentDependencySpecificationMutation>(
                        DeleteIntraComponentDependencySpecificationDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
                "deleteIntraComponentDependencySpecification",
